...
const MODULES = [
  ...
  },
  {
    slug: "services",
    name: "Services",
    description: "Service catalog, prices, and appointment/job availability",
    icon: "Wrench",
    isCore: false,
    sortOrder: 5,
  },
  {
    slug: "hr",
    name: "HR & Staff",
    description: "Employees, scheduling, attendance, leave, and payroll",
    icon: "Briefcase",
    isCore: false,
    sortOrder: 6,
  },
  ...
  },
  {
    slug: "assets",
    name: "Assets",
    description: "Track customer-linked serviceable assets and history",
    icon: "CarFront",
    isCore: false,
    sortOrder: 10,
  },
  {
    slug: "loyalty",
    name: "Loyalty",
    description: "Stamp cards, rewards, and loyalty redemptions",
    icon: "BadgePercent",
    isCore: false,
    sortOrder: 11,
  },
...
async function main() {
  ...
  const frontDeskGroup = await prisma.userGroup.upsert({
    where: { tenantId_name: { tenantId: tenant.id, name: "Front Desk" } },
    update: {},
    create: {
      tenantId: tenant.id,
      name: "Front Desk",
      description: "Reception and customer-facing staff handling appointments, CRM, and reports.",
      permissions: {
  ...
  await prisma.user.upsert({
    ...
    update: { userGroupId: frontDeskGroup.id },
    create: {
      ...
      role: "member",
      tenantId: tenant.id,
      userGroupId: frontDeskGroup.id,
    },
  });
  console.log(
    "✅ Tenant users: owner@demo.com / DemoAdmin123!, admin@demo.com / Member123!, staff@demo.com / Member123!"
  );
  ...
  const shifts = [
    {
      ...
      employeeId: "emp-001",
      title: "Morning Shift",
      startAt: shiftDate(monday, 0, 9, 0),
      endAt: shiftDate(monday, 0, 15, 0),
    },
    {
      id: "shf-002",
      tenantId: tenant.id,
      ...
      startAt: shiftDate(monday, 0, 13, 0),
      endAt: shiftDate(monday, 0, 19, 0),
    },
    {
      id: "shf-003",
      tenantId: tenant.id,
      employeeId: "emp-001",
      title: "Morning Shift",
      startAt: shiftDate(monday, 2, 9, 0),
      endAt: shiftDate(monday, 2, 15, 0),
    },
    {
      id: "shf-004",
      tenantId: tenant.id,
      employeeId: "emp-003",
      title: "Full Day",
      startAt: shiftDate(monday, 1, 9, 0),
      endAt: shiftDate(monday, 1, 18, 0),
    },
    {
      id: "shf-005",
      tenantId: tenant.id,
      employeeId: "emp-004",
      title: "Full Day",
      startAt: shiftDate(monday, 3, 9, 0),
      endAt: shiftDate(monday, 3, 18, 0),
    },
    {
      id: "shf-006",
      tenantId: tenant.id,
      employeeId: "emp-002",
      title: "Morning Shift",
      startAt: shiftDate(monday, 4, 9, 0),
      endAt: shiftDate(monday, 4, 14, 0),
    },
  ];
  ...
  const appointments = [
    {
      id: "apt-001",
      tenantId: tenant.id,
      title: "Haircut & Blowdry – Claire",
      customerName: "Claire Mendoza",
      customerPhone: "09171112222",
      employeeId: "emp-001",
      serviceId: "svc-001",
      startAt: shiftDate(monday, 0, 10, 0),
      endAt: shiftDate(monday, 0, 11, 0),
      status: "done",
    },
    {
      id: "apt-002",
      ...
      customerPhone: "09182223333",
      employeeId: "emp-002",
      serviceId: "svc-002",
      startAt: shiftDate(monday, 1, 10, 0),
      endAt: shiftDate(monday, 1, 12, 0),
      status: "confirmed",
    },
    {
      id: "apt-003",
      tenantId: tenant.id,
      title: "Facial Basic – Dana",
      customerName: "Dana Reyes",
      customerPhone: "09193334444",
      employeeId: "emp-004",
      serviceId: "svc-005",
      startAt: shiftDate(monday, 2, 11, 0),
      endAt: shiftDate(monday, 2, 12, 0),
      status: "pending",
    },
    {
      id: "apt-004",
      tenantId: tenant.id,
      title: "Manicure – Beth",
      customerName: "Beth Santos",
      customerPhone: "09204445555",
      employeeId: "emp-003",
      serviceId: "svc-007",
      startAt: shiftDate(monday, 3, 13, 0),
      endAt: shiftDate(monday, 3, 13, 45),
      status: "confirmed",
    },
    {
      id: "apt-005",
      tenantId: tenant.id,
      title: "Highlights – Jess",
      customerName: "Jessica Chan",
      customerPhone: "09215556666",
      employeeId: "emp-001",
      serviceId: "svc-003",
      startAt: shiftDate(monday, 4, 9, 0),
      endAt: shiftDate(monday, 4, 11, 30),
      status: "pending",
    },
    {
      id: "apt-006",
      tenantId: tenant.id,
      title: "Keratin – Mia",
      customerName: "Mia Ocampo",
      customerPhone: "09226667777",
      employeeId: "emp-002",
      serviceId: "svc-004",
      startAt: shiftDate(monday, 5, 10, 0),
      endAt: shiftDate(monday, 5, 13, 0),
      status: "pending",
    },
  ];
  ...
  const customers = [
    {
      ...
      phone: "09171112222",
      address: "123 Marigold St, Quezon City",
      tags: ["regular", "vip"],
    },
    {
      id: "cus-002",
      ...
      phone: "09182223333",
      address: "456 Sampaguita Ave, Pasig",
      tags: ["regular"],
    },
    {
      id: "cus-003",
    ...
    },
    {
      ...
      email: "mia@email.com",
      phone: "09226667777",
      address: "321 Rose Blvd, Taguig",
      tags: ["regular"],
    },
    {
      id: "cus-007",
      tenantId: tenant.id,
      name: "Tricia Villanueva",
      phone: "09237778888",
      tags: ["new"],
    },
    {
  ...
  const invoices = [
    {
      ...
      dueDate: shiftDate(monday, 7, 0, 0),
      subtotal: "4500.00",
      tax: "540.00",
      total: "5040.00",
      status: "paid",
      paidAt: shiftDate(monday, -3, 0, 0),
      items: [
        {
          id: "ii-001",
        ...
        {
          id: "ii-003",
          description: "Moisturizing Shampoo 500ml",
          quantity: 3,
          unitPrice: "180.00",
          total: "540.00",
        },
    ...
    },
    {
      ...
      dueDate: shiftDate(monday, 14, 0, 0),
      subtotal: "2500.00",
      tax: "300.00",
      total: "2800.00",
      status: "sent",
    ...
    },
    {
      ...
      dueDate: shiftDate(monday, -5, 0, 0),
      subtotal: "1500.00",
      tax: "180.00",
      total: "1680.00",
      status: "overdue",
    ...
    },
    {
      ...
      dueDate: shiftDate(monday, 21, 0, 0),
      subtotal: "800.00",
      tax: "96.00",
      total: "896.00",
      status: "draft",
  ...
  const jobOrders = [
    {
      ...
      tenantId: tenant.id,
      jobNo: "JO-0001",
      customerName: "Marco Lim",
      description: "Hair rebonding + treatment package",
      status: "in-progress",
      priority: "high",
      assignedTo: "Sofia Reyes",
      dueDate: shiftDate(monday, 2, 0, 0),
    },
    {
      id: "jo-002",
      tenantId: tenant.id,
      jobNo: "JO-0002",
      customerName: "Nina Buenaventura",
      description: "Full body wax + facial combo",
      status: "pending",
      priority: "normal",
      assignedTo: "Ria Gomez",
      dueDate: shiftDate(monday, 5, 0, 0),
    },
    {
      id: "jo-003",
      ...
      description: "Gel nail set – hands and feet",
      status: "completed",
      priority: "normal",
      assignedTo: "Mark Dela Cruz",
      dueDate: shiftDate(monday, -2, 0, 0),
      completedAt: shiftDate(monday, -3, 0, 0),
    },
    {
      id: "jo-004",
      tenantId: tenant.id,
      jobNo: "JO-0004",
      customerName: "Beth Santos",
      description: "Balayage color with toning",
      status: "pending",
      priority: "urgent",
      assignedTo: "Lena Torres",
      dueDate: shiftDate(monday, 1, 0, 0),
    },
    {
      id: "jo-005",
      tenantId: tenant.id,
  ...
  const leaveRequests = [
    {
      ...
      employeeId: "emp-001",
      type: "vacation",
      startDate: shiftDate(monday, 14, 0, 0),
      endDate: shiftDate(monday, 18, 0, 0),
      reason: "Family trip",
      status: "approved",
    },
    {
      ...
      employeeId: "emp-003",
      type: "sick",
      startDate: shiftDate(monday, -2, 0, 0),
      endDate: shiftDate(monday, -1, 0, 0),
    ...
    },
    {
      ...
      employeeId: "emp-002",
      type: "personal",
      startDate: shiftDate(monday, 7, 0, 0),
      endDate: shiftDate(monday, 7, 0, 0),
    ...
    },
    {
      ...
      employeeId: "emp-004",
      type: "vacation",
      startDate: shiftDate(monday, 21, 0, 0),
      endDate: shiftDate(monday, 25, 0, 0),
      reason: "Annual leave",
      status: "pending",
    },
  ];
